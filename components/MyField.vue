...
export default {
  ...
  methods: {
    ...
    getCardWY(){
      const target = document.getElementsByClassName('c-deck')[0].getElementsByClassName('c-card-front')[0]
    ...
    async selectCard(
      ...
      if ( result ) {
        e.getElementsByClassName('c-card-item')[0].style.transition = 'all 1s ease'
        ...
        await new Promise(resolve => setTimeout(resolve, 1000))
        e.getElementsByClassName('c-card-item')[0].style.top = this.field[0].y + 'px'
        e.getElementsByClassName('c-card-item')[0].style.left = this.field[0].x + 'px'
        await new Promise(resolve => setTimeout(resolve, 1000))
        ...
        const target = document.getElementsByClassName('c-card')[0].getElementsByClassName('c-card-item')[0]
        ...
        e.getElementsByClassName('c-card-item')[0].style.top = this.deck[0].y + 'px'
        e.getElementsByClassName('c-card-item')[0].style.left = this.deck[0].x + 'px'
        await new Promise(resolve => setTimeout(resolve, 1000))
        this.graveyard = [
          {
        ...
        e.getElementsByClassName('c-card-item')[0].style.width = this.card.w + 'px'
        e.getElementsByClassName('c-card-item')[0].style.height = this.card.h + 'px'
        hand = this.hand.map(item => {
          if(item.name === name) {
            return item = {
              name: name,
